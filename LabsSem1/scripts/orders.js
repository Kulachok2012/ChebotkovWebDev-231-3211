...
function loadOrders() {
    return fetch('https://edu.std-900.ist.mospolytech.ru/labs/api/orders?api_key=e8edbd36-da5f-4862-bda5-06eeb0c60a19', {
            method: 'GET'
    })
        .then(response => response.json())
        .then(data => {
...
function editOrder(dishes, order) {
    ...
    document.getElementById('saveButton').addEventListener('click', () => {
        ...
        fetch(`https://edu.std-900.ist.mospolytech.ru/labs/api/orders/${order['id']}?api_key=e8edbd36-da5f-4862-bda5-06eeb0c60a19`, {
            method: 'PUT',
            body: formData,
        })
            .then((response) => response.json())
