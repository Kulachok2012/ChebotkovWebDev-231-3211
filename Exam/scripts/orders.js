...
async function editOrder(products, order) {
    ...
    document.getElementById('saveButton').addEventListener('click', async () => {
        ...
        const response = await fetch(`https://edu.std-900.ist.mospolytech.ru/exam-2024-1/api/orders/${order.id}?api_key=e8edbd36-da5f-4862-bda5-06eeb0c60a19`, {
            method: 'PUT',
            body: formData
        });
