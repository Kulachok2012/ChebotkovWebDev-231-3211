...
class User(Base, UserMixin):
    ...
    reviews: Mapped[list['Review']] = relationship(lazy=False, back_populates='user')
...
class Course(Base):
    ...
    reviews: Mapped[list['Review']] = relationship(lazy=False, back_populates='course')
...
class Review(db.Model):
    ...
    course: Mapped['Course'] = relationship(lazy=False, back_populates='reviews')
